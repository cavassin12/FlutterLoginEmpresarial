...
class _LoginCardState extends State<_LoginCard> with TickerProviderStateMixin {
  ...
  Widget _buildContaField(double width, LoginMessages messages, Auth auth) {
  ...
  Widget build(BuildContext context) {
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                _buildContaField(textFieldWidth, messages, auth),
                SizedBox(height: 20),
    ...
    return  SingleChildScrollView(child: FittedBox(
      child: Card(
